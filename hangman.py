...
class Game_runner:
    ...
    def runner(self):
        ...
        while True:
            ...
            print(curr_color +"Progress: |--------------------------------------------------| 0.0% Complete"+ text_fucker.end)
            #print(chr(27) + "[2J")
            print()
            time.sleep(.3)
            print(curr_color +"Progress: |█████████████-------------------------------------| 30.0% Complete"+ text_fucker.end)
            print()
            #print(chr(27) + "[2J")
            time.sleep(.3)
            print(curr_color +"Progress: |███████████████████████████████████████-----------| 70.0% Complete"+ text_fucker.end)
            print()
            #print(chr(27) + "[2J")
            time.sleep(.3)
            #print(chr(27) + "[2J")
            print(curr_color +"Progress: |██████████████████████████████████████████████████| 100.0% Complete"+ text_fucker.end)
            print()
            print()
            if wrong : 
